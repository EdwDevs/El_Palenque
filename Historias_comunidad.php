...
<body>
    ...
    <section class="main-banner">
        <div class="container">
            ...
            <p>Descubre las leyendas, mitos y eventos históricos que han forjado la identidad cultural del primer pueblo libre de América</p>
        </div>
    </section>
    ...
    <main class="container">
        ...
        <div class="row mb-5">
            <div class="col-lg-10 mx-auto">
                <p class="lead text-center">San Basilio de Palenque es un territorio de memoria viva donde cada historia es un acto de resistencia cultural. Estas narrativas no son simples relatos del pasado, sino herramientas de preservación identitaria que conectan a las nuevas generaciones con sus raíces africanas y cimarronas.</p>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="gallery-item">
                                <img src="https://cloudfront-us-east-1.images.arcpublishing.com/semana/XO4LIOPMJZENPBN2EFBME477JU.jpg" alt="Estatua de Benkos Biohó en la plaza principal de San Basilio de Palenque">
                                <div class="gallery-caption">Estatua de Benkos Biohó ubicada en la plaza principal, su imagen aparece en documentales como "Palenque" (2018) del Ministerio de Cultura.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="gallery-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <p>Primer pueblo libre de América y Patrimonio Cultural Inmaterial de la Humanidad por la UNESCO desde 2005.</p>
