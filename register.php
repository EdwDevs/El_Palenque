        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" id="registerForm">
            ...
            <div class="mb-3">
                ...
                <div class="password-container">
                    ...
                    <span class="password-toggle" id="togglePassword" tabindex="0" role="button" aria-label="Mostrar contraseña">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="rol" name="rol" required aria-describedby="rolHelp">
                    ...
                    <option value="admin" <?php echo ($rol_value === 'admin') ? 'selected' : ''; ?>>Administrador</option>
                </select>
