...
<body>
        ...
        <form action="actualizar_rol.php" method="POST" id="formRol">
            ...
            <div class="mb-4">
                ...
                <select class="form-select" id="rol" name="rol" required aria-describedby="rolHelp">
                    ...
                    <option value="admin" <?php echo $fila['rol'] === 'admin' ? 'selected' : ''; ?>>Administrador
                    </option>
                    <option value="usuario" <?php echo $fila['rol'] === 'usuario' ? 'selected' : ''; ?>>Usuario</option>
                </select>
                <div id="rolHelp" class="form-text mt-2">
                    <i class="fas fa-info-circle"></i> El rol determina los permisos que tendrá el usuario en el
                    sistema.
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            // Confirmar la acción
            if (confirm(
                    `¿Estás seguro de que deseas asignar el rol "${rolSeleccionado}" al usuario "${nombreUsuario}"?`
                    )) {
