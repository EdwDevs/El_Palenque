            ...
            <form method="POST" action="" id="profileForm">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre"
                        value="<?php echo htmlspecialchars($user['nombre'] ?? $_SESSION['usuario'] ?? ''); ?>" required
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        profileForm.addEventListener('submit', function(e) {
            ...
            if (newName !== currentName) {
                if (!confirm(
                        '¿Estás seguro de que deseas cambiar tu nombre de usuario? Tendrás que usar el nuevo nombre para iniciar sesión.'
                        )) {
                    e.preventDefault();
                    return false;
                }
