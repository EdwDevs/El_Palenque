...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content animate__animated animate__fadeIn">
                ...
                <p class="hero-subtitle">Descubre nuestra selección de artesanías, plantas medicinales e instrumentos musicales tradicionales, elaborados con técnicas ancestrales que preservan nuestra cultura.</p>
            </div>
        </div>
    </section>
    ...
    <main class="container py-5">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" id="searchInput" class="search-input border-start-0" placeholder="Buscar productos...">
                    </div>
                </div>
        ...
        <section class="category-section animate__animated animate__fadeInUp" id="<?php echo strtolower(str_replace(' ', '-', $category['name'])); ?>">
            ...
            <div class="products-grid" data-category="<?php echo $cat_id; ?>">
                ...
                <div class="product-card" 
                    ...
                    <div class="product-image-container">
                        ...
                        <button type="button" class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" 
                    ...
                    <div class="product-content">
                        ...
                        <div class="product-footer">
                            ...
                            <div class="product-actions">
                                <button type="button" class="btn-wishlist" data-product-id="<?php echo htmlspecialchars($product['id']); ?>">
                                    <i class="far fa-heart"></i>
                                </button>
                                <button type="button" class="btn-add-cart" data-product-id="<?php echo htmlspecialchars($product['id']); ?>">
    ...
    <footer class="custom-footer">
        <div class="container">
            <div class="footer-content">
                <p class="footer-text">© <?php echo date('Y'); ?> San Basilio de Palenque - Hecho con orgullo en Colombia</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterProducts() {
                ...
                if (searchTerm) {
                    activeFilters.push({ type: 'search', value: searchTerm, label: `Búsqueda: "${searchTerm}"` });
                }
                
                if (selectedCategory) {
                    const categoryName = categoryFilter.options[categoryFilter.selectedIndex].text;
                    activeFilters.push({ type: 'category', value: selectedCategory, label: `Categoría: ${categoryName}` });
                }
                
                if (sortOption) {
                    const sortName = sortFilter.options[sortFilter.selectedIndex].text;
                    activeFilters.push({ type: 'sort', value: sortOption, label: `${sortName}` });
                }
            ...
            function handleQuickView(productId) {
                ...
                document.getElementById('modalProductPrice').textContent = `$${productPrice.toLocaleString('es-CO')}`;
            ...
            const animateOnScroll = function() {
                ...
                sections.forEach(section => {
                    ...
                    if (sectionTop < windowHeight * 0.75 && !section.classList.contains('animate__fadeInUp')) {
