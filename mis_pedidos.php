                        ...
                        <tbody>
                            <?php foreach ($pedidos as $pedido): ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-<?php echo $estado_clase; ?>"><?php echo ucfirst($pedido['estado']); ?></span></td>
                                    <td>
                                        <a href="ver_pedido.php?id=<?php echo $pedido['id']; ?>" class="btn btn-sm btn-outline-primary">
                                            Ver detalles
                                        </a>
                                        <?php if ($pedido['estado'] == 'pendiente'): ?>
                                            <a href="cancelar_pedido.php?id=<?php echo $pedido['id']; ?>" class="btn btn-sm btn-outline-danger ms-1" onclick="return confirm('¿Estás seguro de que deseas cancelar este pedido?');">
                                                Cancelar
                                            </a>
                                        <?php endif; ?>
                                    </td>
