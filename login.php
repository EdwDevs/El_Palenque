...
<head>
    ...
    body {
        ...
        color: #333;
        padding: 20px;
        /* Añadido para mejorar la visualización en dispositivos móviles */
    }
    ...
    .extra-links a {
        ...
        font-weight: 600;
        display: block;
        /* Hace que cada enlace ocupe su propia línea */
    ...
    <div class="login-container">
        ...
        <form action="validar_inicio.php" method="post">
            ...
            <div class="extra-links">
                ...
                <a href="recuperar_contraseña.php"><i class="fas fa-key me-1"></i> ¿Olvidaste tu contraseña?
                    Recupérala</a>
            </div>
        </form>
    </div>
