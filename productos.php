    ...
    <main class="main-content">
        ...
        <div class="search-container">
            ...
            <input type="text" class="search-input" id="searchInput"
                placeholder="Buscar productos por nombre, descripción o categoría..." onkeyup="searchProducts()">
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="categoria_id" class="form-select">
                            ...
                            ?>
                            <option value="<?php echo htmlspecialchars($cat['categoria_id']); ?>"
                                <?php echo $selected; ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="precio_min" class="form-control" placeholder="0"
                            value="<?php echo isset($_GET['precio_min']) ? htmlspecialchars($_GET['precio_min']) : ''; ?>">
                    </div>
                    <!-- Filtro por Precio Máximo -->
                    <div class="col-md-4">
                        <label class="form-label">Precio Máximo</label>
                        <input type="number" step="0.01" name="precio_max" class="form-control" placeholder="0"
                ...
                <table class="products-table" id="productsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="date-cell"><?php echo date('d/m/Y H:i', strtotime($fila['fecha_creacion'])); ?>
                            </td>
                            <td class="action-cell">
                                <a href="actualizar_producto.php?id=<?php echo $fila['id']; ?>"
            ...
            <div class="modal-content">
                ...
                <form id="productForm" action="guardar_producto.php" method="POST"
                    ...
                    <div class="form-group">
                        <label class="form-label">Nombre del Producto</label>
                        <input type="text" name="nombre" class="form-control" placeholder="Digite nombre del producto"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="descripcion" class="form-control"
                            placeholder="Digite descripción del producto" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Precio</label>
                        <input type="text" name="precio" class="form-control" placeholder="Ej: 25000" required
                            pattern="[0-9]+(\.[0-9]{1,2})?" title="Ingrese un número válido (ej. 25000 o 25000.50)">
                    </div>
