...
<head>
    ...
    <meta name="description"
        content="Panel de usuario de Sabor Colombiano - Accede a servicios exclusivos y tus pedidos">
...
<body>
    ...
    <section class="hero">
        ...
        <p>Explora y descubre todos los servicios exclusivos que tenemos para ti. Disfruta de la esencia de nuestra
            tierra: alegría, color y tradición.</p>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Accede a nuestra colección exclusiva de recetas tradicionales
                            colombianas, con instrucciones paso a paso y consejos de nuestros chefs.</p>
    ...
    <section class="features" id="perfil">
        ...
        <div class="feature-card">
            ...
            <p class="feature-description">Actualiza tus datos, cambia tu contraseña y personaliza tus preferencias en
                nuestra plataforma.</p>
            <div class="profile-options">
                <a href="editar_perfil.php" class="btn-info">
                    <i class="fas fa-user-edit"></i> Editar Datos
                </a>
                <a href="cambiar_contrasena.php" class="btn-info"
    ...
    <section class="features" id="contacto" style="margin-bottom: 5rem;">
        ...
        <div class="feature-card">
            ...
            <p class="feature-description">Estamos aquí para ayudarte. Envíanos un mensaje y te responderemos lo antes
                posible.</p>
